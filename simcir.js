...
simcir.$ = function () {
  ...
  var trigger = function (elm, type, data) {
    var event = {
      type: type, target: elm, currentTarget: null,
    ...
    return function (device) {
      ...
      $.each($ports, function (i, $port) {
        ...
        if (portDef.type == 'In') {
          ...
          intfs.push({
            node: inPort, label: portDef.label,
          ...
          intfs.push({
            node: outPort, label: portDef.label,
